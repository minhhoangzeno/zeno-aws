        ...
        <Row className="w-[90%] h-[90%] flex rounded-3xl overflow-hidden">
          <Col
            ...
            <Col className="absolute bottom-0 top-0 left-0 right-0 flex flex-col items-center justify-center text-white">
              <Title className={`mt-[100px] lg:text-[30px] text-[40px] font-bold text-white ${styles.titleWhite}`}>Welcome Back!</Title>
              <Title className="max-w-[60%] text-center text-[16px] mt-5"> To keep contected with us please login with your personal info</Title>
              <Button
